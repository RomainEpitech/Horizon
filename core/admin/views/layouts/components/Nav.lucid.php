            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-sm p-2.5">
                    ...
                    <svg id="theme-toggle-light-icon" class="w-5 h-5 hidden" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 2a1 1 0 1 0 0 2 8 8 0 0 1 8 8 1 1 0 1 0 2 0 10 10 0 0 0-10-10zm0 16a1 1 0 1 0 0 2 10 10 0 0 0 10-10 1 1 0 1 0-2 0 8 8 0 0 1-8 8zm-8-8a1 1 0 1 0 2 0 8 8 0 0 1 8-8 1 1 0 1 0 0-2 10 10 0 0 0-10 10zm2 0a8 8 0 0 1 8 8 1 1 0 1 0 2 0 10 10 0 0 0-10-10zm2 8a1 1 0 1 0-2 0 8 8 0 0 1-8-8 1 1 0 1 0 2 0 8 8 0 0 1 8 8zm6 2a1 1 0 1 0 2 0 8 8 0 0 1-8-8 1 1 0 1 0 0-2 10 10 0 0 0 10 10zm0-16a1 1 0 1 0-2 0 8 8 0 0 1-8 8 1 1 0 1 0 0 2 10 10 0 0 0 10-10z"/>
                    </svg>
                </button>
